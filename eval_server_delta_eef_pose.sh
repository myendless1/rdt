...
PRETRAINED_MODEL=${PRETRAINED_MODEL:-checkpoints/rdt-finetune-astribot-1b-eef/checkpoint-1500}
...
SERVER_LOG=logs/rdt_server_delta_eef_pose.log
CLIENT_JSON=logs/rdt_eval_delta_eef_pose.json
