...
export PRETRAINED_MODEL=${PRETRAINED_MODEL:-/media/damoxing/ckp/rdt-1b}
...
export MAX_TRAIN_STEPS=${MAX_TRAIN_STEPS:-20001}
export CHECKPOINTING_PERIOD=${CHECKPOINTING_PERIOD:-4000}
